...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-chain', __webpack_require__(3));
  Vue.component('detail-chain', __webpack_require__(6));
  Vue.component('form-chain', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    updateEvents: function updateEvents() {
      ...
      return this.field.events.map(function (event) {
        return _this.viaNamespace(event);
      });
    }
  },
  ...
  methods: {
    ...
    viaCurrentNamespace: function viaCurrentNamespace() {
      return this.viaNamespace([this.field.attribute].concat(Array.prototype.slice.call(arguments)).join('.'));
    },
     ...
     */
    viaNamespace: function viaNamespace() {
      return ['chain', [].concat(Array.prototype.slice.call(arguments)).join('.')].join(':');
    },
     ...
     */
    chainUpdated: function chainUpdated(chain, field) {
     ...
     */
    getFields: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(formData) {
        var _this2 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return Nova.request().post('/nova-api/' + this.resourceName + '/chain-fields', formData, {
                  params: {
...
var _Form = __webpack_require__(157);
...
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(106);
...
var _get = __webpack_require__(231);
...
var _debounce = __webpack_require__(227);
...
var _upperFirst = __webpack_require__(242);
...
var Form = function () {
    ...
    _createClass(Form, [{
        ...
        value: function withOptions(options) {
            ...
            this.__http = options.http || window.axios || __webpack_require__(97);
...
var listCacheClear = __webpack_require__(202),
...
var isObject = __webpack_require__(8),
    ...
    nativeKeysIn = __webpack_require__(214);
...
var isArray = __webpack_require__(13),
    ...
    stringToPath = __webpack_require__(222),
...
var castSlice = __webpack_require__(185),
...
var asciiToArray = __webpack_require__(167),
    hasUnicode = __webpack_require__(71),
    unicodeToArray = __webpack_require__(225);
...
var isObject = __webpack_require__(8),
    now = __webpack_require__(239),
    toNumber = __webpack_require__(241);
...
var arrayEach = __webpack_require__(165),
    baseEach = __webpack_require__(168),
    castFunction = __webpack_require__(183),
    isArray = __webpack_require__(13);
...
var baseIsTypedArray = __webpack_require__(174),
    ...
    nodeUtil = __webpack_require__(215);
...
var arrayLikeKeys = __webpack_require__(69),
    baseKeys = __webpack_require__(175),
    isArrayLike = __webpack_require__(22);
...
var arrayLikeKeys = __webpack_require__(69),
    baseKeysIn = __webpack_require__(176),
    isArrayLike = __webpack_require__(22);
...
var createCaseFirst = __webpack_require__(189);
    ...
    _vm._l(_vm.fields, function(field, index) {
      return _c("form-" + field.component, {
        ...
        attrs: {
          ...
          "shown-via-new-relation-modal": _vm.shownViaNewRelationModal
        },
        on: {
